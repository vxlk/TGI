...
public:
	...
	virtual TGIStatus startPoll();
	virtual TGIStatus closePoll();
...
#ifdef TGI_UNREAL
typedef TGIUnrealAPI TGIAPI;
class TGIUnrealAPI : protected TGICppAPI
{
public:

	TGIUnrealAPI();
	TGIStatus startPoll() override;
	TGIStatus closePoll() override;
